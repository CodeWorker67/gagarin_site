        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
            <a
              ...
              className="card-dark flex items-center gap-4 hover:border-gagarin-neon/20"
            >
              <div className="w-12 h-12 rounded-xl bg-gagarin-neon/10 flex items-center justify-center">
                <MessageCircle className="w-6 h-6 text-gagarin-neon" />
              </div>
              <div>
            ...
            <a
              ...
              className="card-dark flex items-center gap-4 hover:border-gagarin-neon/20"
            >
              <div className="w-12 h-12 rounded-xl bg-gagarin-blue/10 flex items-center justify-center">
                <Send className="w-6 h-6 text-gagarin-blue" />
              </div>
              <div>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
              <HelpCircle className="w-5 h-5 text-gagarin-neon" />
              Частые вопросы
            </h2>
            <div className="space-y-3">
              {faqs.map((faq, i) => (
                <motion.div
                  ...
                  className="border border-gagarin-border rounded-xl overflow-hidden"
                >
                  <button

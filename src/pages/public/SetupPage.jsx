        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <h2 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="w-7 h-7 rounded-full bg-gagarin-neon/20 text-gagarin-neon text-sm flex items-center justify-center font-bold">1</span>
              Выберите устройство
            </h2>
                ...
                <button
                  ...
                  className={`p-4 rounded-xl border text-center transition-all ${
                    selectedPlatform === p.id
                      ? 'border-gagarin-neon bg-gagarin-neon/10'
                      : 'border-gagarin-border bg-gagarin-card hover:border-gagarin-neon/30'
                  }`}
                >
          ...
          <AnimatePresence mode="wait">
            {selectedPlatform && (
              ...
              >
                <h2 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                  <span className="w-7 h-7 rounded-full bg-gagarin-neon/20 text-gagarin-neon text-sm flex items-center justify-center font-bold">2</span>
                  Выберите приложение
                </h2>
                    ...
                    >
                      <div>
                        <div className="text-white font-medium flex items-center gap-2">
                          {app.name}
                          {app.recommended && (
                            <span className="text-xs bg-gagarin-green/10 text-gagarin-green px-2 py-0.5 rounded-full">Рекомендуем</span>
                          )}
                        </div>
                      </div>
          ...
          <AnimatePresence mode="wait">
            {selectedApp && (
              ...
              >
                <h2 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                  <span className="w-7 h-7 rounded-full bg-gagarin-neon/20 text-gagarin-neon text-sm flex items-center justify-center font-bold">3</span>
                  Подключение
                </h2>
                ...
                <a
                  ...
                  className="flex items-center gap-3 p-4 rounded-xl bg-gagarin-neon/10 border border-gagarin-neon/30 mb-6 hover:bg-gagarin-neon/20 transition-colors"
                >
                  <Download className="w-5 h-5 text-gagarin-neon" />
                ...
                <div className="space-y-4">
                  {currentSteps.map((step, i) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-gagarin-card border border-gagarin-border flex items-center justify-center flex-shrink-0 mt-0.5">

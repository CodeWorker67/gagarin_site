    ...
    <>
      ...
      <section className="py-20 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex gap-1 p-1 bg-gagarin-card rounded-xl border border-gagarin-border">
              ...
              <motion.div
                ...
                className={`relative card-dark cursor-pointer text-center ${
                  selectedTariff === tariff.id
                    ? 'border-gagarin-neon ring-2 ring-gagarin-neon/50'
                    : ''
                } ${tariff.popular ? 'border-gagarin-neon/20' : ''}`}
              >
                ...
                <ul className="space-y-2 text-xs text-gray-400 text-left">
                  <li className="flex items-center gap-2">
                    <Check className="w-3.5 h-3.5 text-gagarin-green flex-shrink-0" />
                    Безлимит трафик
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-3.5 h-3.5 text-gagarin-green flex-shrink-0" />
                    ...
                    <button
                      ...
                      className={`p-4 rounded-xl border text-center transition-all ${
                        selectedMethod === method.id
                          ...
                          : 'border-gagarin-border bg-gagarin-card text-gray-400 hover:border-white/20'
                      }`}
                    >

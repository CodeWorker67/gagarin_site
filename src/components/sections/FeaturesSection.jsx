        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-gagarin-neon/10 flex items-center justify-center mb-4 group-hover:bg-gagarin-neon/20 transition-colors">
                  <Icon className="w-6 h-6 text-gagarin-neon" />
                </div>

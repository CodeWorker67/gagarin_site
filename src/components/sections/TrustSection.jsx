...
export default function TrustSection() {
  return (
    <section className="py-24 bg-gagarin-card/50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {useCases.map((uc, index) => (
            <motion.div
              ...
              className="glass-card p-6 text-center group hover:border-gagarin-neon/30 transition-all"
            >
              <div className="w-14 h-14 rounded-2xl bg-gagarin-neon/10 flex items-center justify-center mx-auto mb-4 group-hover:bg-gagarin-neon/20 group-hover:scale-110 transition-all">
                <uc.icon className="w-7 h-7 text-gagarin-neon" />
              </div>

...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gagarin-dark/80 backdrop-blur-xl border-b border-gagarin-border">
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-gagarin-dark border-t border-gagarin-border overflow-hidden"
          >
            <div className="px-4 py-4 space-y-2">
              ...
              <div className="pt-2 border-t border-gagarin-border space-y-2">
                {isAuthenticated ? (
